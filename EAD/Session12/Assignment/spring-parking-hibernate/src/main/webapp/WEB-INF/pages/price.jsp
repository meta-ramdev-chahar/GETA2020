...
<script>
        ...
        {
        	var name="xyz";
        	window.location.replace("price.jsp?name="+name);	
        }
        ...
        function curr(value2) 
        {
            ...
            if (value2.value == 'usd') 
            {
                ...
                document.getElementById('cycleTable').innerHTML = "<h1>Hey ! you are registered now.your cost is :" + val + "! </h1>";    
                console.log(val);
            } 
...
<body>
	<table class="table table-striped" id=cycleTable>
		...
		<tbody>
			<tr>
				<td>Rs.5 <label> <input type="button" id="ten"
						class="btn btn-primary" value=5 onclick="ten(this.id)" /></label></td>
				<td>Rs.100 <label> <input type="button"
						id="threeHundred" class="btn btn-primary" value=100
						id="threeHundred" onclick="ten(this.id)" /></label></td>
				<td>Rs.500 <label> <input type="button"
						id="twelveHundred" class="btn btn-primary" value=500
						id="twelveHundred" onclick="ten(this.id)" /></label></td>
			</tr>
		</tbody>
	</table>
	<div id="heading">
